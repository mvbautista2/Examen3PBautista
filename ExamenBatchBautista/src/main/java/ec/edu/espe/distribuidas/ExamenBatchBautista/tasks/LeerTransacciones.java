...
public class LeerTransacciones implements Tasklet, StepExecutionListener{
    ...
    public LeerTransacciones(ApplicationValues applicationValues, MongoTemplate mongoTemplate, ExecutionContext jobContext) {
    ...
    public void beforeStep(StepExecution se) {
        log.info("Generando Consolidado {}", new Date());
    }
